...
_METADATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='listDataset',
    full_name='ai_flow.MetadataService.listDataset',
    index=2,
    containing_service=None,
