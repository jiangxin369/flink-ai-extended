...
_EXECUTIONLABELPROTO = _descriptor.Descriptor(
  name='ExecutionLabelProto',
  full_name='ai_flow.ExecutionLabelProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='ai_flow.ExecutionLabelProto.uuid', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='ai_flow.ExecutionLabelProto.name', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='ai_flow.ExecutionLabelProto.value', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTIONLABELPROTO.fields_by_name['name'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_EXECUTIONLABELPROTO.fields_by_name['value'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
...
DESCRIPTOR.message_types_by_name['ExecutionLabelProto'] = _EXECUTIONLABELPROTO
...
ExecutionLabelProto = _reflection.GeneratedProtocolMessageType('ExecutionLabelProto', (_message.Message,), {
  'DESCRIPTOR' : _EXECUTIONLABELPROTO,
  '__module__' : 'message_pb2'
  # @@protoc_insertion_point(class_scope:ai_flow.ExecutionLabelProto)
  })
_sym_db.RegisterMessage(ExecutionLabelProto)
