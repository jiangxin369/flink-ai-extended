...
class AIFlowClientTestCases(object):
    ...
    def test_save_datasets_list_dataset(self):
        ...
        response_list = client.list_dataset(2, 0)
    ...
    def test_delete_dataset(self):
        ...
        self.assertIsNone(client.list_dataset(1, 0))
