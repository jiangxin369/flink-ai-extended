...
public final class MetadataServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.aiflow.proto.MetadataServiceOuterClass.ListRequest,
      com.aiflow.proto.Message.Response> getListDatasetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "listDataset",
  ...
  public static io.grpc.MethodDescriptor<com.aiflow.proto.MetadataServiceOuterClass.ListRequest,
      com.aiflow.proto.Message.Response> getListDatasetMethod() {
    io.grpc.MethodDescriptor<com.aiflow.proto.MetadataServiceOuterClass.ListRequest, com.aiflow.proto.Message.Response> getListDatasetMethod;
    if ((getListDatasetMethod = MetadataServiceGrpc.getListDatasetMethod) == null) {
      synchronized (MetadataServiceGrpc.class) {
        if ((getListDatasetMethod = MetadataServiceGrpc.getListDatasetMethod) == null) {
          MetadataServiceGrpc.getListDatasetMethod = getListDatasetMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "listDataset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aiflow.proto.MetadataServiceOuterClass.ListRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aiflow.proto.Message.Response.getDefaultInstance()))
              .setSchemaDescriptor(new MetadataServiceMethodDescriptorSupplier("listDataset"))
              .build();
        }
      }
    }
    return getListDatasetMethod;
  }
  ...
  public static abstract class MetadataServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void listDataset(com.aiflow.proto.MetadataServiceOuterClass.ListRequest request,
        io.grpc.stub.StreamObserver<com.aiflow.proto.Message.Response> responseObserver) {
      asyncUnimplementedUnaryCall(getListDatasetMethod(), responseObserver);
    }
  ...
  public static final class MetadataServiceStub extends io.grpc.stub.AbstractAsyncStub<MetadataServiceStub> {
    ...
    public void listDataset(com.aiflow.proto.MetadataServiceOuterClass.ListRequest request,
        io.grpc.stub.StreamObserver<com.aiflow.proto.Message.Response> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getListDatasetMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class MetadataServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MetadataServiceBlockingStub> {
    ...
    /**
     */
    public com.aiflow.proto.Message.Response listDataset(com.aiflow.proto.MetadataServiceOuterClass.ListRequest request) {
      return blockingUnaryCall(
          getChannel(), getListDatasetMethod(), getCallOptions(), request);
    }
  ...
  public static final class MetadataServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MetadataServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.aiflow.proto.Message.Response> listDataset(
        com.aiflow.proto.MetadataServiceOuterClass.ListRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getListDatasetMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_LIST_DATASET = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_DATASET_BY_NAME:
          serviceImpl.getDatasetByName((com.aiflow.proto.MetadataServiceOuterClass.NameRequest) request,
              (io.grpc.stub.StreamObserver<com.aiflow.proto.Message.Response>) responseObserver);
          break;
        case METHODID_LIST_DATASET:
          serviceImpl.listDataset((com.aiflow.proto.MetadataServiceOuterClass.ListRequest) request,
              (io.grpc.stub.StreamObserver<com.aiflow.proto.Message.Response>) responseObserver);
          break;
      ...
      synchronized (MetadataServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getListDatasetMethod())
